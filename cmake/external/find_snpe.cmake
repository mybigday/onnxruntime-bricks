if (NOT SNPE_ARCH_ABI)
    if(MSVC)
        ...
        if (${GEN_PLATFORM} STREQUAL "arm64")
            set(SNPE_ARCH_ABI aarch64-windows-msvc)
        else()
            set(SNPE_ARCH_ABI x86_64-windows-msvc)
        endif()
    else()
        if (CMAKE_SYSTEM_NAME STREQUAL "Android" AND ANDROID_ABI STREQUAL "arm64-v8a")
            set(SNPE_ARCH_ABI aarch64-android)
        elseif (LINUX)
            if (${GEN_PLATFORM} STREQUAL "x64")
                set(SNPE_ARCH_ABI x86_64-linux-clang)
            else()
                set(SNPE_ARCH_ABI aarch64-oe-linux-gcc11.2)
            endif()
        endif()
    endif()
    if (SNPE_ARCH_ABI)
